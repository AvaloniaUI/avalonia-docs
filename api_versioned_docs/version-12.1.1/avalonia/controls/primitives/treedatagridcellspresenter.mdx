...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Inheritance:</span> TreeDataGridColumnarPresenterBase&lt;TreeDataGridColumn&gt; <span className="apiref-page__relation-separator">-&gt;</span> TreeDataGridCellsPresenter
</div>
<div className="apiref-page__meta-row">
...
| [Render](#uid-3850050510) | No summary available. |
...
| [GridLinesVisibility](#uid-3960e15830) | Gets or sets a value indicating which grid lines are drawn by the presenter. |
...
This property is usually bound to [Avalonia.Controls.TreeDataGrid.GridLinesVisibility](xref:Avalonia.Controls.TreeDataGrid.GridLinesVisibility) by the
...
| [GridLinesVisibilityProperty](#uid-9d165c06c9) | Defines the [Avalonia.Controls.Primitives.TreeDataGridCellsPresenter.GridLinesVisibility](xref:Avalonia.Controls.Primitives.TreeDataGridCellsPresenter.GridLinesVisibility) property. |
...
<span id="uid-9d165c06c9"></span>

### GridLinesVisibilityProperty Field

Defines the [Avalonia.Controls.Primitives.TreeDataGridCellsPresenter.GridLinesVisibility](xref:Avalonia.Controls.Primitives.TreeDataGridCellsPresenter.GridLinesVisibility) property.
