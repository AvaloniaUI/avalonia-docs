...
```csharp
public System.Boolean ApplyStyling()
```
...
```csharp
public System.Boolean IsInitialized { get; set; }
```
...
```csharp
public System.Type StyleKey { get; set; }
```
...
```csharp
public Avalonia.StyledProperty<TValue><System.Object> DataContextProperty
```
...
```csharp
public Avalonia.DirectProperty<TOwner,TValue><Avalonia.StyledElement, System.String> NameProperty
```
