...
```csharp
public System.Boolean Equals(Avalonia.Browser.BrowserPlatformOptions other)
```
...
```csharp
public System.String AvaloniaServiceWorkerScope { get; set; }
```
...
```csharp
public System.Func<System.String, System.String> FrameworkAssetPathResolver { get; set; }
```
...
```csharp
public System.Boolean PreferFileDialogPolyfill { get; set; }
```
...
```csharp
public System.Nullable<System.Boolean> PreferManagedThreadDispatcher { get; set; }
```
...
```csharp
public System.Boolean RegisterAvaloniaServiceWorker { get; set; }
```
