...
```csharp
public Boolean DisableAvaloniaAppDelegate { get; set; }
```
...
```csharp
public Boolean DisableDefaultApplicationMenuItems { get; set; }
```
...
```csharp
public Boolean DisableNativeMenus { get; set; }
```
...
```csharp
public Boolean DisableSetProcessName { get; set; }
```
...
```csharp
public Boolean ShowInDock { get; set; }
```
