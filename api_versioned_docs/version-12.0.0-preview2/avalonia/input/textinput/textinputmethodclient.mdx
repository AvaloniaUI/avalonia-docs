...
```csharp
public Void SetPreeditText(String preeditText, Nullable<Int32> cursorPos)
```
...
```csharp
public Boolean SupportsPreedit { get; set; }
```
...
```csharp
public Boolean SupportsSurroundingText { get; set; }
```
