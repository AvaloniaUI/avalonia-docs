...
```csharp
public System.Nullable<System.Boolean> EnableDrawnDecorations { get; set; }
```
...
```csharp
public System.Nullable<System.Boolean> EnableIme { get; set; }
```
...
```csharp
public System.Boolean EnableInputFocusProxy { get; set; }
```
...
```csharp
public System.Nullable<System.Boolean> EnableMultiTouch { get; set; }
```
...
```csharp
public System.Boolean EnableSessionManagement { get; set; }
```
...
```csharp
public System.Action<System.Exception> ExternalGLibMainLoopExceptionLogger { get; set; }
```
...
```csharp
public System.Collections.Generic.IList<System.String> GlxRendererBlacklist { get; set; }
```
...
```csharp
public System.Boolean UseDBusFilePicker { get; set; }
```
...
```csharp
public System.Boolean UseDBusMenu { get; set; }
```
...
```csharp
public System.Boolean UseGLibMainLoop { get; set; }
```
...
```csharp
public System.Nullable<System.Boolean> UseRetainedFramebuffer { get; set; }
```
...
```csharp
public System.String WmClass { get; set; }
```
