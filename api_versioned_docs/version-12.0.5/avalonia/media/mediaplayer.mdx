...
| [SetSourceAsync](#uid-abdaa38c04) | No summary available. |
...
<span id="uid-abdaa38c04"></span>

### SetSourceAsync Method

```csharp
public System.Threading.Tasks.Task SetSourceAsync(Avalonia.Media.MediaSource source)
```

#### Parameters

`source` [Avalonia.Media.MediaSource](xref:Avalonia.Media.MediaSource)
