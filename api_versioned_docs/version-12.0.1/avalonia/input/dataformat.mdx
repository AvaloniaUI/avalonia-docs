...
| [CreateInProcessFormat](#uid-9584d61758) | No summary available. |
...
<span id="uid-9584d61758"></span>

### CreateInProcessFormat Method

```csharp
public Avalonia.Input.DataFormat<T><T> CreateInProcessFormat<T>(string identifier)
```
...
[Avalonia.Input.DataFormat](xref:Avalonia.Input.DataFormat)&lt;T&gt;&lt;T&gt;
