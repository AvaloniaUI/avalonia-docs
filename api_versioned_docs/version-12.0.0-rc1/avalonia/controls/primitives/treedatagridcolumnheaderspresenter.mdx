...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Inheritance:</span> TreeDataGridColumnarPresenterBase&lt;TreeDataGridColumn&gt; <span className="apiref-page__relation-separator">-&gt;</span> TreeDataGridColumnHeadersPresenter
</div>
<div className="apiref-page__meta-row">
...
This presenter coordinates with the [Avalonia.Controls.TreeDataGridColumns](xref:Avalonia.Controls.TreeDataGridColumns) collection to manage column
