...
:::warning
DO NOT use Path property to preserve access to the file or folder. Instead see [Bookmarks](/reference/services/storage/bookmarks) page on how to keep access to the storage items.
...
:::note
If you want to save file path to reuse it later (in combination with TryGetFileFromPathAsync), please consider using [Bookmarks](/reference/services/storage/bookmarks) instead as they are designed to work in sandboxed environment, where user app might not have direct access to the physical file system.
:::