...
If true, WebAuthenticationBroker will avoid platform specific implementation option, and will use [NativeWebDialog](/controls/web/nativewebdialog) based implementation.
