...
:::info
To review the concept behind **data templates**, see [here](/concepts/data-concepts/data-templates/introduction-to-data-templates).
:::
...
| `ItemPanel`                | The container panel to place items in. By default, this is a StackPanel. See [this page](/docs/ui-development/custom-controls/custom-itemspanel) to customise the ItemsPanel.|
