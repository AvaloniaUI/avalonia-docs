...
| `ItemsPanel`               | `ITemplate<Panel>` | The container panel for list items. By default, this is a `StackPanel`. See [Custom panel](/docs/how-to/itemscontrol-how-to#custom-panel) to learn how to customize the `ItemsPanel`. |
