...
<head>
  ...
  <meta
    name="description"
    content="Avalonia comes with lots of high-quality UI controls, including buttons, lists, tabs, etc.. to quickly and easily build your app's user interface."
  />
  <style>{`
    :root {
...
Avalonia apps are made of high-level building blocks called Controls, which allow you to quickly construct the UI for your app. Avalonia comes with lots of controls, including buttons, lists, and tabs. Once you're familiar with the basics, refer to the [API Index](https://api-docs.avaloniaui.net/docs/category/avalonia) for a complete list of each control.
