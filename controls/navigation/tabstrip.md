...
`TabStrip` is composed of `TabStripItem` children. `TabStripItem`s are displayed in order of appearance and can be created by either: 1. a collection of `TabStripItem`s or 2. generated by `ItemsSource`.
...
- [TabStrip API reference](https://api-docs.avaloniaui.net/docs/T_Avalonia_Controls_Primitives_TabStrip)
