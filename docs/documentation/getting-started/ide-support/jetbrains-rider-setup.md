...
![rider-welcome](<./img/jetbrains-rider-setup-1-rider-welcome.png>)

A new Preferences Screen will open up. Click the `Settings` icon as shown and select `Manage Plugin Repositories...`

![configure-plugin-repos](<./img/jetbrains-rider-setup-2-configure-plugin-repos.png>)
...
![plugin-install](<./img/jetbrains-rider-setup-4-plugin-install.png>)
