...
## Subscribing to Changes to a Property <a href="#subscribing-to-changes-to-a-property" id="subscribing-to-changes-to-a-property"></a>
...
## Binding to an observable <a href="#binding-to-an-observable" id="binding-to-an-observable"></a>
...
## Setting a binding in an object initializer <a href="#setting-a-binding-in-an-object-initializer" id="setting-a-binding-in-an-object-initializer"></a>
...
## Transforming binding values <a href="#transforming-binding-values" id="transforming-binding-values"></a>
...
## Using XAML bindings from code <a href="#using-xaml-bindings-from-code" id="using-xaml-bindings-from-code"></a>
...
## Subscribing to a Property on Any Object <a href="#subscribing-to-a-property-on-any-object" id="subscribing-to-a-property-on-any-object"></a>
