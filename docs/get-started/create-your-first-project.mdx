...
For your first project, use the MVVM template. This template sets up a project with the Model-View-ViewModel pattern, which is the recommended way to structure Avalonia applications.
