...
The Avalonia for Visual Studio extension is part of [Avalonia Plus](https://avaloniaui.net/pricing), a suite of professional development tools. A free [Community Edition](/tools/community-edition) is available for individual developers, small organizations (up to five concurrent users), and educational institutions. The Community Edition includes XAML IntelliSense, the XAML previewer, project templates, and code snippets.
