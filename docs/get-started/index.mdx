...
Start by installing the [Avalonia templates](https://github.com/AvaloniaUI/avalonia-dotnet-templates).
...
You can run this command to check what templates you have available for `dotnet new`:

```
 dotnet new list
```

Along with other .NET templates, you should see these Avalonia templates:
...
<Tabs groupId="ide">  
  ...
  7. If given the option to choose target platforms, select **Desktop**. Then, click **Next**.
  8. Select **ReactiveUI** as the toolkit. Then, click **Create**.
  </TabItem>
  <TabItem value="vsc" label="Visual Studio Code">
...
You have now installed Avalonia on your device and know how to create and run Avalonia projects in your IDE.
