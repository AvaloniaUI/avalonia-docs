...
<Tabs groupId="ide">  
  <TabItem value="rider" label="Rider">
	...
	For more information on using the XAML previewer, see the page on [XAML live preview](/docs/ui-development/xaml-preview-and-design-settings).
  </TabItem>
  ...
  If you’re working on Windows, you can use [Visual Studio](https://visualstudio.microsoft.com/) with the Avalonia for Visual Studio extension. This extension supports Visual Studio 2022 version 17.10 and above.
  ...
  For more information on using the XAML previewer, see the page on [previewing your UI design](/docs/guides/ui-development/preview-and-design-time).
  </TabItem>
...
Having issues with the installation? Check the [installation troubleshooting page](/troubleshooting/installation).
