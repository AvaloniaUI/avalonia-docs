...
Now that you have [installed Avalonia](/docs/get-started/install-avalonia), [set up your IDE](/docs/get-started/set-up-your-ide), and [created your first project](/docs/get-started/create-your-first-project), we can go through some basic concepts and functionalities in Avalonia. We’re going to do that by turning the default Avalonia template into a temperature converter app.
