...
doc-type: tutorial
video:
  src: https://youtu.be/ZWfHOWs1HkE
  title: Convert User Input in Avalonia — TryParse, Validation & Live UI Updates
---
...
Here is how to implement this logic in the C# code-behind.
