...
doc-type: tutorial
video:
  src: https://youtu.be/Qk2lzIKR00g
  title: Add Your First Controls to an Avalonia UI — TextBlock, Button & Binding
---
...
For a complete list of the built-in controls, see [Controls](/controls).
...
:::tip
You can also set [`VerticalAlignment`](/api/avalonia/layout/verticalalignment) to control where a control sits along the vertical axis. Try setting `VerticalAlignment="Center"` on your button to see the effect.
:::
...
- [Button reference](/controls/input/buttons/button)
- [Controls overview](/controls)
- [Adding some layout](/docs/get-started/starter-tutorial/adding-some-layout) (next step in this tutorial)
