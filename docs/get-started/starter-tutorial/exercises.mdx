...
<details>
	...
	Check the [`TextBox` API reference](/api/avalonia/controls/textbox) for more information on the `TextBox` control.
</details>

<details>
	<summary>Hint (2nd)</summary>

	Under the [API reference for `TextBox`](/api/avalonia/controls/textbox), you’ll find the attribute `IsReadOnly`.
</details>
...
<details>
	...
	Under the [API reference for `TextBox`](/api/avalonia/controls/textbox), you’ll find the event `TextChanged`.
</details>
...
- Learn about Avalonia's [fundamentals](/docs/fundamentals/avalonia-xaml)
- Understand the [MVVM design pattern](/docs/fundamentals/the-mvvm-pattern)
- Explore options for UI [styling](/docs/styling/styles)
- See the full list of [Avalonia controls](/controls)
