...
doc-type: tutorial
video:
  src: https://youtu.be/VlZITaBIfs4
  title: Set Up Your Avalonia Window — Size, Title and Icon Properties
---
...
:::note
The first few lines of the `<Window>` tag declare the XML namespaces used by Avalonia. The namespace aliases used are `x`, `vm`, `d`, and `mc`.
:::
...
For more information, see the page on [previewing your UI design](/docs/app-development/xaml-preview-and-design-settings).
