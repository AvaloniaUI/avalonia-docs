...
doc-type: tutorial
video:
  src: https://youtu.be/BMqXR4eZVvc
  title: Avalonia Button Events — Wire Up a Click Handler Without MVVM
---
...
- [Adding some layout](/docs/get-started/starter-tutorial/adding-some-layout): The previous step in this tutorial.
- [Implementing the conversion](/docs/get-started/starter-tutorial/converting-data): The next step in this tutorial.
