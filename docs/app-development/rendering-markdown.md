...
You can override named resources for custom styling. See the [Markdown styling](/docs/markdown/markdown-styling) page for details.

## See also

- [Markdown control](/controls/data-display/text-display/markdown)
- [Code highligher](/docs/markdown/codehighlighter)
- [Image loader](/docs/markdown/imageloader)
- [Markdown styling](/docs/markdown/markdown-styling)