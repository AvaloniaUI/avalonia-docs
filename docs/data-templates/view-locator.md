...
:::info
ViewLocator is optional and included in default Avalonia templates. You can use explicit [DataTemplates](/docs/data-templates/data-template-collection) instead.
:::
...
See [DataTemplates Collection](/docs/data-templates/data-template-collection).
...
- [DataTemplates](/docs/data-templates/introduction-to-data-templates)
- [DataTemplates Collection](/docs/data-templates/data-template-collection)
- [Implementing IDataTemplate](/docs/data-templates/creating-data-templates-in-code)
