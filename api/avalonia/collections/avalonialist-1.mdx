...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/master/src/Avalonia.Base/Collections/AvaloniaList.cs">AvaloniaList.cs</a>
</div>
...
- It can be configured to notify the [Avalonia.Collections.AvaloniaList&lt;T&gt;.CollectionChanged](xref:Avalonia.Collections.AvaloniaList%601.CollectionChanged) event with a System.Collections.Specialized.NotifyCollectionChangedAction.Remove action instead of a System.Collections.Specialized.NotifyCollectionChangedAction.Reset when the list is cleared by setting [Avalonia.Collections.AvaloniaList&lt;T&gt;.ResetBehavior](xref:Avalonia.Collections.AvaloniaList%601.ResetBehavior) to [Avalonia.Collections.ResetBehavior.Remove](xref:Avalonia.Collections.ResetBehavior.Remove).
