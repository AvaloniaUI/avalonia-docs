...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Base/Media/Imaging/Bitmap.cs">Bitmap.cs</a>
</div>
...
| [Save (4 overloads)](#uid-2db10525bf) | No summary available. |
...
<span id="uid-6d7c09e157"></span>

#### Save Method

```csharp
public void Save(System.IO.Stream stream, Avalonia.Media.Imaging.BitmapEncoderOptions options)
```
...
```csharp
public void Save(string fileName, Avalonia.Media.Imaging.BitmapEncoderOptions options)
```
