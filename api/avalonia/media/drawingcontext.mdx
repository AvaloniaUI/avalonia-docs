...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Base/Media/DrawingContext.cs">DrawingContext.cs</a>
</div>
...
| [PushEffect](#uid-5cbe64db83) | Pushes an effect. |
...
```csharp
public Avalonia.Media.DrawingContext.PushedState PushEffect(Avalonia.Media.IEffect effect, Avalonia.Rect bounds)
```
...
A disposable used to undo the effect.
