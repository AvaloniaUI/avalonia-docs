...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/main/src/Avalonia.Base/Media/GlyphRun.cs">GlyphRun.cs</a>
</div>
...
| [InkBounds](#uid-cdd7824107) | Gets the conservative bounding box of the inked area of the [Avalonia.Media.GlyphRun](xref:Avalonia.Media.GlyphRun). |
...
Gets the conservative bounding box of the inked area of the [Avalonia.Media.GlyphRun](xref:Avalonia.Media.GlyphRun).
