...
```csharp
public System.Boolean Equals(Avalonia.Media.TextOptions other)
```
...
```csharp
public System.Void SetBaselinePixelAlignment(Avalonia.Visual visual, Avalonia.Media.BaselinePixelAlignment value)
```
...
```csharp
public System.Void SetTextHintingMode(Avalonia.Visual visual, Avalonia.Media.TextHintingMode value)
```
...
```csharp
public System.Void SetTextOptions(Avalonia.Visual visual, Avalonia.Media.TextOptions value)
```
