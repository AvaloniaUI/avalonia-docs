...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Base/Media/PreciseEllipticArcHelper/PreciseEllipticArcHelper.EllipticalArc.cs">PreciseEllipticArcHelper.EllipticalArc.cs</a>
</div>
...
- Thrown if defaultFlatness is lower than 1e-10
...
- Thrown if maxDegree is not between 1 and 3
