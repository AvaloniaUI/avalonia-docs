...
```csharp
public Void DrawRectangle(Avalonia.Media.Immutable.ImmutablePen pen, Avalonia.Rect rect, Single cornerRadius)
```
...
```csharp
public Void FillRectangle(Avalonia.Media.IImmutableBrush brush, Avalonia.Rect rect, Single cornerRadius)
```
