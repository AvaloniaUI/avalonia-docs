...
Each entry in the dictionary maps a System.Globalization.CultureInfo to
...
The dictionary contains entries for each supported culture, where the key is a System.Globalization.CultureInfo representing the culture, and the value is the corresponding localized family name. The
