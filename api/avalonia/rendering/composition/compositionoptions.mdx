...
```csharp
public Nullable<Int32> MaxDirtyRects { get; set; }
```
...
```csharp
public Nullable<Boolean> UseRegionDirtyRectClipping { get; set; }
```
...
```csharp
public Nullable<Boolean> UseSaveLayerRootClip { get; set; }
```
