...
```csharp
public System.Nullable<System.Double> DirtyRectMergeEagerness { get; set; }
```
...
```csharp
public System.Nullable<System.Int32> MaxDirtyRects { get; set; }
```
...
```csharp
public System.Nullable<System.Boolean> UseRegionDirtyRectClipping { get; set; }
```
...
```csharp
public System.Nullable<System.Boolean> UseSaveLayerRootClip { get; set; }
```
