...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/main/src/Avalonia.Base/Animation/Animation.cs">Animation.cs</a>
</div>
...
| [PlaybackBehavior](#uid-68ef901b16) | Gets or sets the playback behavior for this animation. When set to [Avalonia.Animation.PlaybackBehavior.Auto](xref:Avalonia.Animation.PlaybackBehavior.Auto), manually started animations and animations targeting [Avalonia.Visual.IsVisibleProperty](xref:Avalonia.Visual.IsVisibleProperty) always play, while style-applied animations pause when the control is not effectively visible (see [Avalonia.Visual.IsEffectivelyVisible](xref:Avalonia.Visual.IsEffectivelyVisible)). |
...
<span id="uid-68ef901b16"></span>

### PlaybackBehavior Property

Gets or sets the playback behavior for this animation.
When set to [Avalonia.Animation.PlaybackBehavior.Auto](xref:Avalonia.Animation.PlaybackBehavior.Auto), manually started animations and
animations targeting [Avalonia.Visual.IsVisibleProperty](xref:Avalonia.Visual.IsVisibleProperty) always play,
...
| [PlaybackBehaviorProperty](#uid-7d3043d9e6) | Defines the [Avalonia.Animation.Animation.PlaybackBehavior](xref:Avalonia.Animation.Animation.PlaybackBehavior) property. |
...
<span id="uid-7d3043d9e6"></span>

### PlaybackBehaviorProperty Field

Defines the [Avalonia.Animation.Animation.PlaybackBehavior](xref:Avalonia.Animation.Animation.PlaybackBehavior) property.
