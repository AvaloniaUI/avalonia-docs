...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Controls/INavigation.cs">INavigation.cs</a>
</div>
...
| [RemovePage](#uid-9985148e2b) | Removes `page` from the navigation stack without animation. If `page` is not in the stack the call is a no-op. |
...
- [\`page\` or \`before\` is .](xref:System.ArgumentNullException)
- [\`before\` is not in the navigation stack, or \`page\` is already hosted by this navigation page.](xref:System.InvalidOperationException)
...
If `page` is not in the stack the call is a no-op.
...
- [\`page\` is .](xref:System.ArgumentNullException)
