...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Controls/Embedding/Offscreen/OffscreenTopLevelImplBase.cs">OffscreenTopLevelImplBase.cs</a>
</div>
...
| [SetFrameThemeVariant](#uid-df4448f453) | No summary available. |
...
<span id="uid-df4448f453"></span>

### SetFrameThemeVariant Method

```csharp
public void SetFrameThemeVariant(Nullable<Avalonia.Platform.PlatformThemeVariant> themeVariant)
```

#### Parameters

`themeVariant` Nullable&lt;[Avalonia.Platform.PlatformThemeVariant](xref:Avalonia.Platform.PlatformThemeVariant)&gt;
