...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Controls/Design.cs">Design.cs</a>
</div>
...
| [SetPreviewWith (8 overloads)](#uid-d8dac897b3) | Sets a preview control for the specified [Avalonia.AvaloniaObject](xref:Avalonia.AvaloniaObject) at design-time. |
...
<span id="uid-c162a7ef5e"></span>

#### SetPreviewWith Method

Sets a preview control for the specified [Avalonia.AvaloniaObject](xref:Avalonia.AvaloniaObject) at design-time.

```csharp
public void SetPreviewWith(Avalonia.AvaloniaObject target, Avalonia.Controls.Control control)
```
