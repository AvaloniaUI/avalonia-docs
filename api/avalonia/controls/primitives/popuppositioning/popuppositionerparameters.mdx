...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/main/src/Avalonia.Controls/Primitives/PopupPositioning/IPopupPositioner.cs">IPopupPositioner.cs</a>
</div>
...
| [Deflate](#uid-3a9f414a77) | Gets or sets how far to deflate [Avalonia.Controls.Primitives.PopupPositioning.PopupPositionerParameters.Size](xref:Avalonia.Controls.Primitives.PopupPositioning.PopupPositionerParameters.Size) when positioning the popup. |
...
<span id="uid-3a9f414a77"></span>

### Deflate Property

Gets or sets how far to deflate [Avalonia.Controls.Primitives.PopupPositioning.PopupPositionerParameters.Size](xref:Avalonia.Controls.Primitives.PopupPositioning.PopupPositionerParameters.Size) when positioning the popup.

```csharp
public Avalonia.Thickness Deflate { get; set; }
```
