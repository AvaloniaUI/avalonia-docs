...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Controls/Primitives/PopupFlyoutBase.cs">PopupFlyoutBase.cs</a>
</div>
...
| [IsOpen](flyoutbase.mdx#uid-fd374d2468) | Gets or sets whether this Flyout is currently open. Inherited from [FlyoutBase](flyoutbase.mdx). |
