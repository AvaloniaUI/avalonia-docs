...
Button. To change the style for a control class, override the [Avalonia.StyledElement.StyleKeyOverride](xref:Avalonia.StyledElement.StyleKey)
property
...
System.ComponentModel.ISupportInitialize.EndInit is called *and* the styled element
is attached to a rooted logical tree. When the styled element is created by code and
System.ComponentModel.ISupportInitialize is not used, it is called when the styled element is attached
to the visual tree.
