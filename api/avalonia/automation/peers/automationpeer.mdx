...
```csharp
public System.Void BringIntoView()
```
...
```csharp
public System.String GetAcceleratorKey()
```
...
```csharp
public System.String GetAccessKey()
```
...
```csharp
public System.String GetAutomationId()
```
...
```csharp
public System.Int32 GetHeadingLevel()
```
...
```csharp
public System.String GetHelpText()
```
...
```csharp
public System.String GetItemStatus()
```
...
```csharp
public System.String GetItemType()
```
...
```csharp
public System.Nullable<Avalonia.Automation.Peers.AutomationLandmarkType> GetLandmarkType()
```
...
```csharp
public System.String GetLocalizedControlType()
```
...
```csharp
public System.String GetPlaceholderText()
```
...
```csharp
public System.Boolean HasKeyboardFocus()
```
...
```csharp
public System.Boolean IsContentElement()
```
...
```csharp
public System.Boolean IsControlElement()
```
...
```csharp
public System.Boolean IsKeyboardFocusable()
```
...
```csharp
public System.Boolean IsOffscreen()
```
...
```csharp
public System.Void RaisePropertyChangedEvent(Avalonia.Automation.AutomationProperty property, System.Object oldValue, System.Object newValue)
```
...
```csharp
public System.Boolean ShowContextMenu()
```
...
```csharp
public event System.EventHandler<Avalonia.Automation.AutomationPropertyChangedEventArgs> PropertyChanged
```
