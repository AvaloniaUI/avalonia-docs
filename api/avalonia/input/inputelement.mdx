...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/main/src/Avalonia.Base/Input/InputElement.cs">InputElement.cs</a>
</div>
...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Derived types:</span> <a href="../controls/control">Control</a>, <a href="../controls/documents/primitives/documentnodes/documentnode">DocumentNode</a>
</div>
<div className="apiref-page__meta-row">
...
| [SwipeGestureEndedEvent](#uid-8492058651) | Defines the [Avalonia.Input.InputElement.SwipeGestureEnded](xref:Avalonia.Input.InputElement.SwipeGestureEnded) event. |
...
<span id="uid-8492058651"></span>

### SwipeGestureEndedEvent Field

Defines the [Avalonia.Input.InputElement.SwipeGestureEnded](xref:Avalonia.Input.InputElement.SwipeGestureEnded) event.
...
| [DoubleTapped](#uid-ad13083e0c) | Occurs when the user briefly contacts and releases twice on a single point, without significant movement. |
...
| [Holding](#uid-8cda030fe2) | Occurs when the user makes a single contact, then maintains contact beyond a given time threshold without releasing or making another contact. |
...
| [Pinch](#uid-96b68421dc) | Occurs when the user moves two contact points closer together. |
| [PinchEnded](#uid-50614bd917) | Occurs when the user releases both contact points used in a pinch gesture. |
...
| [PointerTouchPadGestureMagnify](#uid-8f1fe6dc4a) | Occurs when the user moves two contact points away from each other on a touchpad. |
| [PointerTouchPadGestureRotate](#uid-d966c43661) | Occurs when the user places two contact points and moves them in a circular motion on a touchpad. |
| [PointerTouchPadGestureSwipe](#uid-9011c6de89) | Occurs when the user performs a rapid dragging motion in a single direction on a touchpad. |
...
| [PullGesture](#uid-d85f52cac5) | Occurs when the user drags from the edge of a control. |
| [PullGestureEnded](#uid-a37f51b846) | Occurs when the user releases the pointer after a pull gesture. |
...
| [RightTapped](#uid-11a576692d) | Occurs when the user briefly contacts and releases a single point, without significant movement, using a mechanism on the input device recognized as a right button or equivalent. |
| [ScrollGesture](#uid-b571ab3acc) | Occurs when the user continuously moves the pointer in the same direction within the control’s boundaries. |
| [ScrollGestureEnded](#uid-eb3914c3a8) | Occurs when a scroll gesture has fully stopped, taking into account any inertial movement that continues the scroll after the user has released the pointer. |
| [ScrollGestureInertiaStarting](#uid-c8cd2731a5) | Occurs within a scroll gesture, when the user releases the pointer, and scrolling continues by transitioning to momentum-based gliding movement. |
| [SwipeGesture](#uid-0f4fc613ec) | Occurs when the user rapidly drags the pointer in a single direction across the control. |
| [SwipeGestureEnded](#uid-137ae2fd9d) | Occurs when a swipe gesture ends on the control. |
| [Tapped](#uid-6df36c079d) | Occurs when the user briefly contacts and releases a single point, without significant movement. |
