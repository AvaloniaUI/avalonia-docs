...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Base/Input/IAsyncDataTransfer.cs">IAsyncDataTransfer.cs</a>
</div>
...
- When an implementation of this interface is returned from the clipboard via [Avalonia.Input.Platform.IClipboard.TryGetDataAsync](xref:Avalonia.Input.Platform.IClipboard.TryGetDataAsync%28%29), it MUST be disposed the caller.
