...
| [User](#uid-7d2b4dd18f) | An interactive element set by user code that should receive input even when overlapping chrome areas. Has the same effect as Avalonia.Input.WindowDecorationsElementRole.DecorationsElement but is intended for use by application developers. |
