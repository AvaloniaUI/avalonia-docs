...
```csharp
public System.Int32 CompareTo(Avalonia.Threading.DispatcherPriority other)
```
...
```csharp
public System.Boolean Equals(Avalonia.Threading.DispatcherPriority other)
```
...
```csharp
public Avalonia.Threading.DispatcherPriority FromValue(System.Int32 value)
```
...
```csharp
public System.Void Validate(Avalonia.Threading.DispatcherPriority priority, System.String parameterName)
```
