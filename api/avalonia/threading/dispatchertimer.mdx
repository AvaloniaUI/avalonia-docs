...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/main/src/Avalonia.Base/Threading/DispatcherTimer.cs">DispatcherTimer.cs</a>
</div>
...
| Name | Description |
| --- | --- |
| [DispatcherTimer (6 overloads)](#uid-c83de3d8be) | Creates a timer that uses [Avalonia.Threading.Dispatcher.CurrentDispatcher](xref:Avalonia.Threading.Dispatcher.CurrentDispatcher) to process the timer event at background priority. |
...
Creates a timer that uses [Avalonia.Threading.Dispatcher.CurrentDispatcher](xref:Avalonia.Threading.Dispatcher.CurrentDispatcher) to
...
<span id="uid-866d558367"></span>

#### DispatcherTimer Constructor

Creates a timer that uses the specified [Avalonia.Threading.Dispatcher](xref:Avalonia.Threading.Dispatcher) to
process the timer event at the specified priority.
...
```csharp
public DispatcherTimer(TimeSpan interval, Avalonia.Threading.DispatcherPriority priority, Avalonia.Threading.Dispatcher dispatcher)
```
...
```csharp
public DispatcherTimer(TimeSpan interval, Avalonia.Threading.DispatcherPriority priority, Avalonia.Threading.Dispatcher dispatcher, EventHandler callback)
```
