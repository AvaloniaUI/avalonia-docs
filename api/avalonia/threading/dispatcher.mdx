...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/main/src/Avalonia.Base/Threading/Dispatcher.cs">Dispatcher.cs</a>
</div>
...
| [ToTaskScheduler (2 overloads)](#uid-9ea307a8a9) | Gets a [System.Threading.Tasks.TaskScheduler](xref:System.Threading.Tasks.TaskScheduler) which executes tasks on this [Avalonia.Threading.Dispatcher](xref:Avalonia.Threading.Dispatcher). A [Avalonia.Threading.DispatcherPriority](xref:Avalonia.Threading.DispatcherPriority) is captured from the current [Avalonia.Threading.AvaloniaSynchronizationContext](xref:Avalonia.Threading.AvaloniaSynchronizationContext) if one is available. Otherwise, [Avalonia.Threading.DispatcherPriority.Default](xref:Avalonia.Threading.DispatcherPriority.Default) is used. |
...
<span id="uid-9ea307a8a9"></span>

### ToTaskScheduler overloads

<section className="apiref-page__member-entry">

<span id="uid-b951cd3058"></span>

#### ToTaskScheduler Method

Gets a [System.Threading.Tasks.TaskScheduler](xref:System.Threading.Tasks.TaskScheduler) which executes tasks on this [Avalonia.Threading.Dispatcher](xref:Avalonia.Threading.Dispatcher). A [Avalonia.Threading.DispatcherPriority](xref:Avalonia.Threading.DispatcherPriority) is captured from
the current [Avalonia.Threading.AvaloniaSynchronizationContext](xref:Avalonia.Threading.AvaloniaSynchronizationContext) if one is available. Otherwise, [Avalonia.Threading.DispatcherPriority.Default](xref:Avalonia.Threading.DispatcherPriority.Default) is used.

```csharp
public System.Threading.Tasks.TaskScheduler ToTaskScheduler()
```
...
<span id="uid-6089ecadd9"></span>

#### ToTaskScheduler Method

Gets a [System.Threading.Tasks.TaskScheduler](xref:System.Threading.Tasks.TaskScheduler) which executes tasks on this [Avalonia.Threading.Dispatcher](xref:Avalonia.Threading.Dispatcher) with the specified [Avalonia.Threading.DispatcherPriority](xref:Avalonia.Threading.DispatcherPriority).

```csharp
public System.Threading.Tasks.TaskScheduler ToTaskScheduler(Avalonia.Threading.DispatcherPriority priority)
```
...
| [UIThread](#uid-7402828ab2) | Gets the dispatcher for the UI thread. |
...
Control and libraries author are encouraged to use [Avalonia.Threading.Dispatcher.CurrentDispatcher](xref:Avalonia.Threading.Dispatcher.CurrentDispatcher) and
[Avalonia.AvaloniaObject.Dispatcher](xref:Avalonia.AvaloniaObject.Dispatcher) instead.
