...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Base/Platform/Storage/IStorageProvider.cs">IStorageProvider.cs</a>
</div>
...
| [OpenFilePickerAsync](#uid-22907f4437) | Opens the file picker dialog. |
| [OpenFilePickerWithResultAsync](#uid-726f9331ff) | Opens the file picker dialog and returns additional information about the result. |
...
| [OpenFolderPickerAsync](#uid-6bb27fee7f) | Opens the folder picker dialog. |
| [SaveFilePickerAsync](#uid-4e68fc0b1f) | Opens the save file picker dialog. |
| [SaveFilePickerWithResultAsync](#uid-1a9bca9667) | Opens the save file picker dialog and returns additional information about the result. |
...
<span id="uid-726f9331ff"></span>

### OpenFilePickerWithResultAsync Method

Opens the file picker dialog and returns additional information about the result.

```csharp
public System.Threading.Tasks.Task<Avalonia.Platform.Storage.OpenFilePickerResult> OpenFilePickerWithResultAsync(Avalonia.Platform.Storage.FilePickerOpenOptions options)
```
...
System.Threading.Tasks.Task&lt;[Avalonia.Platform.Storage.OpenFilePickerResult](xref:Avalonia.Platform.Storage.OpenFilePickerResult)&gt;

[Avalonia.Platform.Storage.OpenFilePickerResult](xref:Avalonia.Platform.Storage.OpenFilePickerResult) with selected files and additional dialog information such as selected file type.
...
| Name | Description |
| --- | --- |
| [CanOpen](#uid-821d88f63c) | Returns true if it's possible to open the file picker on the current platform. |
| [CanPickFolder](#uid-c5a5582867) | Returns true if it's possible to open the folder picker on the current platform. |
| [CanSave](#uid-15d3347cf3) | Returns true if it's possible to open the save file picker on the current platform. |
