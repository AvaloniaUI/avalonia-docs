...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Base/Platform/Storage/IStorageItem.cs">IStorageItem.cs</a>
</div>
...
This interface inherits IDisposable . It's recommended to dispose [Avalonia.Platform.Storage.IStorageItem](xref:Avalonia.Platform.Storage.IStorageItem) when it's not used anymore.
