...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.OpenGL/GlInterface.cs">GlInterface.cs</a>
</div>
...
| [DrawBuffer](#uid-5b30f2075a) | No summary available. |
| [DrawElements](#uid-ea6a2579e2) | No summary available. |
| [EGLImageTargetTexture2DOES](#uid-e69b7519ac) | No summary available. |
...
| [ReadBuffer](#uid-f18e2d416c) | No summary available. |
...
| [WriteBuffer](#uid-15371c9e56) | No summary available. |
...
<span id="uid-e69b7519ac"></span>

### EGLImageTargetTexture2DOES Method

```csharp
public void EGLImageTargetTexture2DOES(int target, IntPtr image)
```
...
<span id="uid-15371c9e56"></span>

### WriteBuffer Method

```csharp
public void WriteBuffer(int buffer)
```
...
| [IsDrawBufferAvailable](#uid-ae439ec1f1) | No summary available. |
| [IsEGLImageTargetTexture2DOESAvailable](#uid-dbc8abc7da) | No summary available. |
| [IsGenVertexArraysAvailable](#uid-31ec4cb68b) | No summary available. |
| [IsReadBufferAvailable](#uid-8767069a1e) | No summary available. |
| [IsWriteBufferAvailable](#uid-2111b1b34f) | No summary available. |
...
<span id="uid-ae439ec1f1"></span>

### IsDrawBufferAvailable Property

```csharp
public bool IsDrawBufferAvailable { get; set; }
```
...
<span id="uid-dbc8abc7da"></span>

### IsEGLImageTargetTexture2DOESAvailable Property

```csharp
public bool IsEGLImageTargetTexture2DOESAvailable { get; set; }
```
...
<span id="uid-8767069a1e"></span>

### IsReadBufferAvailable Property

```csharp
public bool IsReadBufferAvailable { get; set; }
```
...
<span id="uid-2111b1b34f"></span>

### IsWriteBufferAvailable Property

```csharp
public bool IsWriteBufferAvailable { get; set; }
```
