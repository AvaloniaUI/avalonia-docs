...
- Thrown if inheritVariant is a reference to the \[Avalonia.Styling.ThemeVariant.Default\](xref:Avalonia.Styling.ThemeVariant.Default) which is ambiguous value to inherit.
