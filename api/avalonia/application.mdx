...
<div className="apiref-page__meta-row">
<span className="apiref-page__meta-label">Source:</span> <a href="https://github.com/AvaloniaUI/Avalonia/blob/3111696698e2c3d6fe9aace8cb954153ee16b3e4/src/Avalonia.Controls/Application.cs">Application.cs</a>
</div>
...
- Registers services needed by the rest of Avalonia in the [Avalonia.Application.RegisterServices](xref:Avalonia.Application.RegisterServices%28%29)
method.
...
[Avalonia.Controls.TopLevel](xref:Avalonia.Controls.TopLevel)'s [Avalonia.Controls.TopLevel.PlatformSettings](xref:Avalonia.Controls.TopLevel.PlatformImpl) is an equivalent API
