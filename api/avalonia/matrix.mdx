...
```csharp
public Matrix(System.Double scaleX, System.Double skewY, System.Double skewX, System.Double scaleY, System.Double offsetX, System.Double offsetY)
```
...
```csharp
public Matrix(System.Double scaleX, System.Double skewY, System.Double perspX, System.Double skewX, System.Double scaleY, System.Double perspY, System.Double offsetX, System.Double offsetY, System.Double perspZ)
```
...
```csharp
public System.Boolean ContainsPerspective()
```
...
```csharp
public Avalonia.Matrix CreateRotation(System.Double radians)
```
...
```csharp
public Avalonia.Matrix CreateRotation(System.Double radians, Avalonia.Point center)
```
...
```csharp
public Avalonia.Matrix CreateScale(System.Double xScale, System.Double yScale)
```
...
```csharp
public Avalonia.Matrix CreateSkew(System.Double xAngle, System.Double yAngle)
```
...
```csharp
public Avalonia.Matrix CreateTranslation(System.Double xPosition, System.Double yPosition)
```
...
```csharp
public System.Boolean Equals(Avalonia.Matrix other)
```
...
```csharp
public System.Double GetDeterminant()
```
...
```csharp
public Avalonia.Matrix Parse(System.String s)
```
...
```csharp
public System.Double ToRadians(System.Double angle)
```
...
```csharp
public System.Boolean TryDecomposeTransform(Avalonia.Matrix matrix, Avalonia.Matrix.Decomposed& decomposed)
```
...
```csharp
public System.Boolean TryInvert(Avalonia.Matrix& inverted)
```
...
```csharp
public System.Boolean HasInverse { get; set; }
```
...
```csharp
public System.Double M11 { get; set; }
```
...
```csharp
public System.Double M12 { get; set; }
```
...
```csharp
public System.Double M13 { get; set; }
```
...
```csharp
public System.Double M21 { get; set; }
```
...
```csharp
public System.Double M22 { get; set; }
```
...
```csharp
public System.Double M23 { get; set; }
```
...
```csharp
public System.Double M31 { get; set; }
```
...
```csharp
public System.Double M32 { get; set; }
```
...
```csharp
public System.Double M33 { get; set; }
```
