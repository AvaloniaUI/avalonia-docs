...
> Note: The following examples assume an instance of `MainWindowViewModel` is assigned to the Window's `DataContext`. See [the section on `DataContext`](/docs/basic/data/data-binding/data-context) for more information.
...
For more information see the [data templates](/docs/basic/data/data-templates.md) section.
