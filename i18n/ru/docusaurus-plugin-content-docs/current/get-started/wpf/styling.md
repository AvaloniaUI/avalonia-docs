...
- [`Style (рус: Стили)`](/docs/basic/user-interface/styling) - это CSS-подобные стили.
Они хранятся в коллекции `Styles`, а не `Resources`, как у WPF. 
- [`ControlTheme`](/docs/basic/user-interface/styling/control-themes) подобны `Style` у WPF, 
