      ...
      'items': [
        {
          ...
          'collapsed': true,
          'items': [
            'guides/app-development/cross-platform-solution-setup',
            'guides/app-development/dependency-injection',
            'guides/app-development/localizing',
            'guides/app-development/logging-errors-and-warnings',
            {
              'type': 'category',
              'label': 'ReactiveUI',
              'collapsed': true,
              'items': [{'type': 'autogenerated', 'dirName': 'guides/app-development/reactiveui'},],
            },
          ],
        },
        {
          ...
          'collapsed': true,
          'items': [
            'guides/ui-development/resource-dictionary',
            {
              'type': 'category',
              'label': 'Custom controls',
              'collapsed': true,
              'items': [{'type': 'autogenerated', 'dirName': 'guides/ui-development/custom-controls'},],
            },
            {
              'type': 'category',
              'label': 'Graphics',
              'collapsed': true,
              'items': [{'type': 'autogenerated', 'dirName': 'guides/ui-development/graphics'},],
            },
            'guides/ui-development/preview-and-design-time',
            {
              'type': 'category',
              'label': 'Styling',
              'collapsed': true,
              'items': [{'type': 'autogenerated', 'dirName': 'guides/ui-development/styling'},],
            },
          ],
        },
        {
          ...
          'collapsed': true,
          'items': [{'type': 'autogenerated', 'dirName': 'guides/development-optimization'},],
        },
        {
          'type': 'category',
          'label': 'Data',
          'collapsed': true,
          'items': [{'type': 'autogenerated', 'dirName': 'guides/data'},],
        },
        {
          'type': 'category',
