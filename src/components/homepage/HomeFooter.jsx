    ...
    return (
        <footer className="styles.footer">
            ...
            <div>
                ...
                <p className="max-w-xs mt-4 font-medium text-sm text-gray-600">
                  One codebase.
                </p>
                <p className="max-w-xs -mt-4 font-medium text-sm text-gray-600">
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                    ...
                    <a className="hover:opacity-75 text-gray-600 text-lg font-jakarta" href="https://github.com/avaloniaui/avaloniavs"> Avalonia for Visual Studio</a>
                    <a className="hover:opacity-75 text-gray-600 text-lg font-jakarta" href="https://github.com/ForNeVeR/AvaloniaRider"> Avalonia for Rider </a>
                    <a className="hover:opacity-75 text-gray-600 text-lg font-jakarta" href="https://github.com/avaloniaui/avalonia-dotnet-templates"> .NET Templates </a>
                </nav>
                </div>
                <div>
            ...
            <p className="mt-8 text-xs text-center text-gray-400">
                © 2024 - AvaloniaUI OÜ (14839404).
            </p>
            <p className="-mt-3  -mb-10 text-xs text-center text-gray-400">
