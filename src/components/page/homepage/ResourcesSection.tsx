...
const ALL_RESOURCES: Resource[] = [
  {
    url: 'https://avaloniaui.net/Blog/is-wpf-dead?av_source=docs&av_medium=homepage_link&av_content=blog-is-wpf-dead',
    type: 'blog',
    title: 'Is WPF Dead?',
    description:
  ...
  {
    url: 'https://avaloniaui.net/Blog/balancing-growth-and-sustainability-avalonia-s-financial-evolution?av_source=docs&av_medium=homepage_link&av_content=blog-financial-evolution',
    type: 'blog',
  ...
  {
    url: 'https://avaloniaui.net/Blog/10-years-of-avalonia?av_source=docs&av_medium=homepage_link&av_content=blog-10-years',
    type: 'blog',
