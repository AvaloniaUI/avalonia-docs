...
Gets the platform's [Clipboard](/reference/services/clipboard) implementation.
...
Gets [focus manager](/reference/services/focus-manager) of the root.
...
Gets the platform's [InsetsManager](/reference/services/insets-manager) implementation.
...
Represents a contract for accessing top-level [platform-specific settings](/reference/services/platform-settings).
...
[File System storage](/reference/services/storage/storage-provider) service used for file pickers and bookmarks.
