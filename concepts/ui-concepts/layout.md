...
id: layout
title: Layout
description: Understand how the Avalonia layout system measures, arranges, and positions controls using panels and bounding boxes.
doc-type: concept
---
...
Avalonia includes a group of elements that derive from `Panel`. These `Panel` elements enable many complex layouts. For example, you can stack elements by using the `StackPanel` element, while more complex and free-flowing layouts are possible by using a `Canvas`.
...
- [StackPanel](/docs/reference/controls/stackpanel): Arranges children in a single horizontal or vertical line.
- [Grid](/docs/reference/controls/grid): Defines a flexible grid area with columns and rows.
- [DockPanel](/docs/reference/controls/dockpanel): Docks child elements to the edges of the panel.
- [Canvas](/docs/reference/controls/canvas): Positions children at explicit coordinates.
