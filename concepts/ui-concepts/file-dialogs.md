...
For more information on StorageProvider service including on how to keep access to the picked files and what possible options are supported, please visit [`StorageProvider`](/reference/services/storage/storage-provider) documentation page and subpages.
