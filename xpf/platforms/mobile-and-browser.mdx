...
:::tip
The [CalculatorDemo repository](https://github.com/AvaloniaUIOU/CalculatorDemo) contains a working example of XPF on all platforms. Ask the support team for access if needed.
:::
